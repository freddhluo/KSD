...
data = rbind(lr_SP5, lr_CSCO, lr_INTC)
...
for (t in 1:test_size){
  ...
  mu_t_l = M + A1 %*% data_all[,(2274+t-1)] + 
      A2 %*% data_all[,(2274+t-2)] + 
      A3 %*% data_all[,(2274+t-3)]
  ...
  sigma2_t_l = a + B %*% (Yt[2274-order,])^2 +
    G %*% ht[2274-order,]
...
rp = w %*% data_all[,(2274+1):(2274+test_size)]
