...
# Import data
data_SP5 = read.csv("C:/Users/luodh/OneDrive - connect.hku.hk/Time Series Research/KSD paper/KSD Real Data Application/SP500.csv", header = TRUE)
...
# data_SP5a = read.csv("C:/Users/luodh/OneDrive - connect.hku.hk/Time Series Research/KSD paper/KSD Real Data Application/SP5001.csv", header = TRUE)
# data_CSCOa = read.csv("C:/Users/luodh/OneDrive - connect.hku.hk/Time Series Research/KSD paper/KSD Real Data Application/CSCO1.csv", header = TRUE)
# data_INTCa = read.csv("C:/Users/luodh/OneDrive - connect.hku.hk/Time Series Research/KSD paper/KSD Real Data Application/INTC1.csv", header = TRUE)


SP5 = data_SP5$Adj.Close
CSCO = data_CSCO$Adj.Close
INTC = data_INTC$Adj.Close

# SP5a = data_SP5a$Adj.Close
# CSCOa = data_CSCOa$Adj.Close
# INTCa = data_INTCa$Adj.Close
...
lr_SP5 = (log(SP5[2:2275]) - log(SP5[1:2274])) * 100
lr_CSCO = (log(CSCO[2:2275]) - log(CSCO[1:2274])) * 100
lr_INTC = (log(INTC[2:2275]) - log(INTC[1:2274])) * 100

data_all = rbind(lr_SP5, lr_CSCO, lr_INTC)
...
data_test = data_all[,(2274-test_size+1):2274]
data = data_all[,1:(2274-test_size)]
...
fit2 = restrict(x = fit1, method = "ser", thresh = 2)
Yt = residuals(fit2)
order = fit2$p[[1]]
coef = Acoef(fit2)
A1 = coef[[1]]
...
for (t in 1:test_size){
  mu_t_l = M + A1 %*% data_all[,(2274-test_size+t-1)] + 
    A2 %*% data_all[,(2274-test_size+t-2)] + 
    A3 %*% data_all[,(2274-test_size+t-3)]
  mu_list = cbind(mu_list, mu_t_l)
  
  sigma2_t_l = a + B %*% (Yt[2274-test_size-order,])^2 +
    G %*% ht[2274-test_size-order,]
...
rp = w %*% data_all[,(2274-test_size+1):(2274)]
...
# test_size = 800
# w = 0.004 0.993 0.004 
# 0.011 0.011 0.133 0.336 0.011 0.008


# test_size = 1200
# w = 0.004 0.971 0.025 
# 0.032 0.076 0.583 0.113 0.059 0.136


#####################################################
# w = (1.4 -0.2 -0.2)
# unconditional coverage
# N  0.0693309945 0.0001639796
# t  0.2331573933 0.5664502375
# SN 0.0927472413 0.0004381301

# conditional coverage
# N  0.1143379085 0.0005769022
# t  0.3309849605 0.4219992263
# SN 0.2030672580 0.0020501921

# w = (1/3,1/3,1/3)
# N  1.000000000 0.460852518 
# t  0.013962135 0.005292895 
# SN 0.773049734 0.460852518

# N  0.629972405 0.761770425
# t  0.048366490 0.007101774
# SN 0.687586310 0.761770425
