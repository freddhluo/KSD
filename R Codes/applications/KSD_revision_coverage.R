...
data_AA = read.csv("C:/Users/luodh/OneDrive - connect.hku.hk/Time Series Research/KSD paper/KSD revision/AA.csv", header = TRUE)
data_CAT = read.csv("C:/Users/luodh/OneDrive - connect.hku.hk/Time Series Research/KSD paper/KSD revision/CAT.csv", header = TRUE)
data_DIS = read.csv("C:/Users/luodh/OneDrive - connect.hku.hk/Time Series Research/KSD paper/KSD revision/DIS.csv", header = TRUE)
data_UL = read.csv("C:/Users/luodh/OneDrive - connect.hku.hk/Time Series Research/KSD paper/KSD revision/UL.csv", header = TRUE)
...
lr_UL = (log(UL[2:2850]) - log(UL[1:2849])) * 100

# data_all = rbind(lr_MSFT, lr_AAPL, lr_INTC)
data_all = rbind(lr_AAPL, lr_CAT, lr_UL)
...
# 0.847 0.838 0.494 0.622 0.905 0.838
